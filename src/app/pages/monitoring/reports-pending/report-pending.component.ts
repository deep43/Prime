...
@Component({
  ...
  styleUrls: [
    './report-pending.component.scss',
    '../../../../assets/icon/icofont/css/icofont.scss',
  ],
  encapsulation: ViewEncapsulation.None
})

export class ReportPendingComponent implements OnInit {
  ...
  columnDefs = [
    ...
    },
    {
      ...
      cellStyle: {'text-align': 'center', 'padding-top': '4px', 'font-size': '13px'}, suppressMovable: true,
      cellRenderer: (params) => {
        let className = '';
